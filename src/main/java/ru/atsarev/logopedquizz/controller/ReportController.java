...
import ru.atsarev.logopedquizz.dto.Quizz;
...
public class ReportController {
    ...
    @ResponseBody
    public FileSystemResource  generateDocument(@RequestBody Report report) throws IOException {
        DocumentBuilder docBuilder = new DocumentBuilder();
        File doc = docBuilder.createWord(report);
        return new FileSystemResource(doc);
    }
}
