...
function printResults(){
    ...
    if (quiz.checkAnswers()) {
        ...
        // Highlight questions according to whether they were correctly answered. The callback allows us to highlight/show the correct answer
        quiz.highlightResults(handlePrintAnswers);
    }

    function handlePrintAnswers(quiz, question, no, correct) {
        question.getElementsByClassName(Quiz.Classes.QUESTION_TITLE)[0].classList.replace(Quiz.Classes.INCORRECT, Quiz.Classes.CORRECT);
    }
